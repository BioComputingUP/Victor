...
namespace Victor { namespace Energy {
     ...
     * 
     *   This class implements a simple torsion potential based on the statistical preference of aminoacid types for phi, psi, chi1, chi2, omega, prephi and pre psi angles..
     * @This 
     * */
